...
const instructions_1a = {
  ...
  on_start: function(trial) {
    ...
    pass_message('two-step', 'instructions 1');
...
const practice_1_node = {
  ...
  conditional_function: function() {
    ...
    if ( (practice_1_counter >= 3 && n_trial >= 5) || practice_1_loops >= 3 ) {
      return false;
    } else {
      return true;
    }
...
const practice_1_help_node = {
  ...
  conditional_function: function() {
    if ( practice_1_counter >= 3 || practice_1_loops >= 3 ) {
      return false;
    } else {
      return true;
    }
...
// Practice counter #1
const practice_1_incrementer = {
  type: 'call-function',
  func: function(){ practice_1_loops++; }
}
...
const instructions_loop_1b = {
  timeline: [
    ...
    practice_1_node, practice_1_node, practice_1_node, practice_1_node, practice_1_node, practice_1_node, practice_1_node, practice_1_incrementer, practice_1_help_node
  ],
  loop_function: function(data) {
    if ( practice_1_counter >= 3 || practice_1_loops >= 3 ) {
      return false;
...
const instructions_2a = {
  ...
  on_start: function(trial) {
    ...
    pass_message('two-step', 'instructions 2');
...
const instructions_3a = {
  ...
  on_start: function(trial) {
    ...
    // passage message to nivturk
    pass_message('two-step', 'instructions 3');
