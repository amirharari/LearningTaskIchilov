...
var instructions_01 = {
  ...
  pages: [
    ...
    },
    {
      ...
      img: '../../static/img/risk/instructions.png'
    },
    {
...
const practice_01_trial = {
  type: 'mrst-trial',
  stimulus: '../../static/img/risk/animals/rabbit-shape.svg',
  color: '#3d85c690',
  points: '10',
...
var instructions_02 = {
  ...
  pages: [
    ...
    },
    {
      ...
      show_cards: true,
      stimulus: '../../static/img/risk/animals/horse-black-shape.svg',
      color: '#6aa84f91'
    },
    {
...
var quiz = {
  ...
  on_finish: function(data) {
    if (data.num_errors > max_errors) {
      n_comp_loops++;
      pass_message('risk', 'repeating quiz');
    }
  }
}
